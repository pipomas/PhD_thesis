...
Spearmans Rangkorrelationen ($r_{s}$) zwischen den vier Bedingungen der \gls{ssauf} deuteten ausnahmslos auf starke Zusammenhänge hin (siehe Tabelle \ref{tab:shzmanifest}).
