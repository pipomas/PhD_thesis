...
Deskriptive Angaben zu den 18 eingesetzten Subtests des \gls{bist} sind in Tabelle \ref{tab:BISdescriptives} zu finden. Die negativen und positiven Schiefen respektive Kurtosen wiesen wie die Shapiro-Wilk-Tests bei vielen Subtests darauf hin, dass die Daten moderat von der Normalverteilung abwichen \citep{Finney2006}. 
Aus diesem Grund wurden die Zusammenhänge zwischen den Subtests mit Spearmans Rangkorrelationskoeffizienten bestimmt. Wie aufgrund der Modellannahmen im \gls{bist} zu erwarten war, liessen sich zwischen der Mehrheit der Subtests substanzielle Zusammenhänge beobachten (siehe Tabelle \ref{tab:subtestsCorr}). 
