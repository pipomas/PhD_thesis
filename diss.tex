...
Mit der ersten Fragestellung sollte geprüft werden, ob der von \citet{Melnick2013} berichtete Zusammenhang zwischen dem \gls{si} und psychometrischer Intelligenz (Studie 1: $r~=~.64$, $p~=~.02$ und Studie 2: $r~=~.71$, $p~<~.001$) wiederholt werden kann. 
...
\begin{figure}[b]
	...
	\caption[Spatial-Index-Intelligenz-Zusammenhang]{Zusammenhang  zwischen dem \gls{si} und dem \gls{zwert} aus dem \gls{bist} ($r_{s}=.04$, $p=.57$).}
	\label{fig:si-z}
\end{figure}
