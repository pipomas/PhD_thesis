...
\begin{figure}[htbp]
	...
	%	\captionsetup{font = small}
	\begin{adjustbox}{width=1\textwidth}
		\subfloat[Test][Zusammenhang zwischen der Asymptote und dem \gls{zwert} des \gls{bist}]{\input{tikzDevice/spatial_suppression_rmse_cutoff_asymptote_zscore.tex}}
	\end{adjustbox}
		\newline
	\begin{adjustbox}{width=1\textwidth}
		\subfloat[Test][Zusammenhang zwischen der Steigung und dem \gls{zwert} des \gls{bist}]{\input{tikzDevice/spatial_suppression_rmse_cutoff_slope_zscore.tex}}
	\end{adjustbox}
			
	\caption[RMSE einfluss]{Einfluss der Modellkonformität auf die Zusammenhänge der aus der exponentiellen Regression abgeleiteten Aufgabenparameter der Asymptote ($a$) und der Steigung ($b$) mit dem \gls{zwert} des \gls{bist}. Die durchgezogene Linie kennzeichnet... . Der graue Bereich kennzeichnet das $95\,\%$-Konfidenzintervall. Die gestrichelte Linie kennzeichnet einen Zusammenhang von 0.}
