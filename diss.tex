...
Zuerst wurde geprüft, ob die Mustergrösse einen signifikanten Einfluss auf die Wahrnehmungsleistung der \glspl{vp} ausübte. Dafür wurde ein Friedman-Test durchgeführt. Der Globaltest hat darauf hingedeutet, dass sich die Bedingungen signifikant voneinander unterschieden, $\upchi^2(3)=343.88$, $p<.001$. 
...
Spearmans Rangkorrelationen ($r_{s}$) zwischen den vier Bedingungen der \gls{ssauf} wiesen ausnahmslos auf starke Zusammenhänge hin. Relativ betrachtet bestand der tiefste Zusammenhang zwischen der \(1.8^{\circ}\)- und der \(7.2^{\circ}\)-Bedingung ($r_{s}~=~.54$, $p~<~.001$) und der höchste Zusammenhang zwischen der \(5.4^{\circ}\)- und der \(7.2^{\circ}\)-Bedingung ($r_{s}~=~.88$, $p~<~.001$). Alle Korrelationen zwischen den vier Bedingungen der \gls{ssauf} sind in Tabelle \ref{tab:shzmanifest} zu finden.
