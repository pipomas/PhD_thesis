...
18	&	WE	&	.42{$^{***}$}	&	.27{$^{***}$}	&	.26{$^{***}$}	&	.19{$^{*}$}		&	.29{$^{***}$}	&	.25{$^{***}$}	&	.06				&	.04				&	.14			&	.21{$^{**}$}	&	.25{$^{**}$}	&	.20{$^{**}$}	&	.33{$^{***}$}	&.19{$^{*}$}&	.23{$^{**}$}&.18{$^{*}$}&-.12&\\
		...
		\begin{tablenotes}[flushleft]
			...
			\item {$^a$}Der exakte Zusammenhang betrug $r_{s}=.147$, $p=.051$. {$^b$}Der exakte Zusammenhang betrug $r_{s}=.151$, $p=.045$. {$^c$}Der exakte Zusammenhang betrug $r_{s}=.152$, $p=.044$. {$^d$}Der exakte Zusammenhang betrug $r_{s}=.153$, $p=.043$. {$^e$}Der exakte Zusammenhang betrug $r_{s}=.151$, $p=.045$. {$^f$}Der exakte Zusammenhang betrug $r_{s}=.150$, $p=.047$. 
...
Der \gls{si} korrelierte in der vorliegenden Arbeit mit $r_{s}~=~.04$ ($p~=~.57$) mit dem \gls{zwert} aus dem \gls{bist} (siehe Abbildung~\ref{fig:si-z}).

 und fiel damit signifikant tiefer aus als in Studie 1 von \citet{Melnick2013} 
...
(Studie 1: $r~=~.64$, $p~=~.02$ und Studie 2: $r~=~.71$, $p~<~.001$) 
