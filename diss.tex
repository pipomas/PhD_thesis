...
Deskriptiven Angaben zur Aufgabe sind in Tabelle \ref{tab:SSdescriptives} zu finden. Die Schwellenschätzungen der vier Bedingungen waren nicht normalverteilt (alle $p\textnormal{s}<.01$), weshalb alle Analysen der \gls{ssauf} mit nonparametrischen Tests durchgeführt wurden. Um zu prüfen, ob sich die 

Post-hoc-Tests \citep{Galili2010} 
(Wilcoxon-Nemenyi-McDonald-Thompson)
\citep[siehe Seite 295 in][]{Hollander1999} wurden mit Co
