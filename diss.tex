...
Die aus der exponentiellen Regression abgeleitete Asymptote korrelierte in der vorliegenden Arbeit leicht negativ mit dem \gls{zwert} des \gls{bist}. Die Steigung, der zweite mit der exponentiellen Regression abgeleitete Aufgabenparameter, hing nicht signifikant mit dem \gls{zwert} zusammen. Der von \citet{Melnick2013} berichtete Zusammenhang zwischen der Steigung und psychometrischer Intelligenz konnte damit nicht bestätigt werden. 
...
Betrachtet man die mit der Gesamtstichprobe ermittelten Ergebnisse, kann festgehalten werden, dass sowohl der y-Achsenabschnitt ($r=-.17$, $p=.02$) als auch die Steigung ($r=-.23$, $p=.002$) der \gls{ha} leicht negativ mit dem \gls{zwert} des \gls{bist} zusammenhing. Diese Zusammenhänge waren vergleichbar mit den von \citet{Jensen1987a} berichteten Ergebnissen.
...
\begin{table}[htb]
	...
	\begin{threeparttable}
		\begin{tabular}{
			...
			\rowgroup{Modell 12}	&		&			&			&			&	&	4.40{$^{**}$}	&	.09		&					\\
			H-y-Achsenabschnitt			&	0.0008	&	0.0020	&	.04		&	.70		&	&					&			&					\\
			H-Steigung				&	-0.0027	&	0.0022	&	-.16	&	.22		&	&					&			&					\\
			
			\rule{0pt}{4ex}			%  EXTRA vertical height
			
			\rowgroup{Modell 13}	&		&			&			&			&	&	2.71{$^{**}$}	&	.11		& 1.02	&	.02		\\
			H-y-Achsenabschnitt				&	0.0018	&	0.0021	&	.10		&	.40		&	&					&			&					\\
			H-Steigung				&	-0.0031	&	0.0022	&	-.19	&	.16		&	&					&			&					\\
			S-Asymptote				&	-0.0009	&	0.0014	&	-.09	&	.51		&	&					&			&					\\
			S-Steigung				&	-0.0008	&	0.0010	&	-.11	&	.41		&	&					&			&					\\
			\hline
		\end{tabular}
