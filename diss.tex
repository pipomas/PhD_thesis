...
\begin{figure}[htb]
	...
	\resizebox{1\textwidth}{!}{% or alternatively .919 
		\input{tikzDevice/suppression_index_histogram.tex}}
...
Spearmans Rangkorrelationen zwischen den vier Bedingungen der \gls{ssauf} deuteten ausnahmslos auf starke Zusammenhänge hin (siehe Tabelle \ref{tab:correlations_manifest}).

Der \gls{si} wies einen Mittelwert $\pm$ Standardabweichung von $0.222\,\pm\,0.160$ (Minimum $= -0.185$, Maximum $= 0.886$) auf. Die positive Schiefe ($0.91$) und Kurtosis ($1.80$) deutete im Vergleich mit der Normalverteilung auf eine linkssteile, spitze Verteilung hin. Ein Shapiro-Wilk-Test zeigte dann mit $p<.001$ auch an, dass der \gls{si} nicht normalverteilt war (siehe Abbildung \ref{fig:SIhist}).
...
Die negativen und positiven Schiefen respektive Kurtoses wiesen zusammen mit Shapiro-Wilk-Tests bei 15 der 18 Subtests darauf hin, dass die Daten von der Normalverteilung abwichen\footnote{Die Analyse der Verteilung mit Anderson-Darling-Tests identifizierte 16 der 18 Subtests als nicht normalverteilt. Lilliefors-Tests kamen ebenfalls bei 16 von 18 Subtests zum Ergebnis, dass die Verteilung von von der Normalverteilung abwich.}. 
...
5	&	WA	&	.31{$^{***}$}	&	.41{$^{***}$}	&	.47{$^{***}$}	&	.34{$^{***}$}	&	&	&	&	&	&	&	&	&	&	&	&	&	&	\\
6	&	ZP	&	.27{$^{***}$}	&	.15				&	.15{$^{*}$}		&	.30{$^{***}$}	&	.17{$^{*}$}		&	&	&	&	&	&	&	&	&	&	&	&	&	\\
7	&	TM	&	.29{$^{***}$}	&	.26{$^{***}$}	&	.41{$^{***}$}	&	.36{$^{***}$}	&	.48{$^{***}$}	&	.24{$^{**}$}	&	&	&	&	&	&	&	&	&	&	&	&	\\
8	&	BD	&	.19{$^{*}$}		&	.08				&	.17{$^{*}$}		&	.19{$^{*}$}		&	.02				&	.08				&	.10	&	&	&	&	&	&	&	&	&	&	&	\\
9	&	SC	&	.16{$^{*}$}		&	.51{$^{***}$}	&	.35{$^{***}$}	&	.48{$^{***}$}	&	.22{$^{**}$}	&	.17{$^{*}$}		&	.32{$^{***}$}	&	.25{$^{***}$}	&	&	&	&&&	&&	&&\\
10	&	ST	&	.34{$^{***}$}	&	.15	{$^{*}$}	&	.23{$^{**}$}	&	.30{$^{***}$}	&	.31{$^{***}$}	&	.22{$^{**}$}	&	.37{$^{***}$}	&	-.03			&	.22{$^{**}$}	&		&&&&&&&&\\
11	&	CH	&	.33{$^{***}$}	&	.49{$^{***}$}	&	.51{$^{***}$}	&	.29{$^{***}$}	&	.50{$^{***}$}	&	.14				&	.30				&	.12				&	.31{$^{***}$}	&	.13	&	&	&&&	&&&	\\
12	&	TG	&	.33{$^{***}$}	&	.36{$^{***}$}	&	.30{$^{***}$}	&	.48{$^{***}$}	&	.45{$^{***}$}	&	.19{$^{*}$}		&	.47{$^{***}$}	&	.18{$^{*}$}		&	.26{$^{***}$}&	.36{$^{***}$}	&	.23{$^{**}$}	&	&&	&	&&&	\\
13	&	RZ	&	.32{$^{***}$}	&	.52{$^{***}$}	&	.42{$^{***}$}	&	.55{$^{***}$}	&	.44{$^{***}$}	&	.29{$^{***}$}	&	.45{$^{***}$}	&	.13				&	.44{$^{***}$}&	.34{$^{***}$}	&	.37{$^{***}$}	&	.41{$^{***}$}&&&&&&	\\
14	&	WM	&	.41{$^{***}$}	&	.10				&	.24{$^{**}$}	&	.18{$^{*}$}		&	.20{$^{**}$}	&	.26{$^{***}$}	&	.34{$^{***}$}	&	.13				&	.13			&	.45{$^{***}$}	&	.16{$^{*}$}		&	.18{$^{*}$}		&	.15{$^{*}$}	&&&&&	\\
15	&	KW	&	.26{$^{***}$}	&	.24{$^{***}$}	&	.28{$^{***}$}	&	.39{$^{***}$}	&	.39{$^{***}$}	&	.24{$^{**}$}	&	.54{$^{***}$}	&	.19{$^{*}$}		&	.26{$^{***}$}&	.49{$^{***}$}	&	.21{$^{**}$}	&	.60{$^{***}$}	&	.35{$^{***}$}	&	.34{$^{***}$}	&&&&	\\
16	&	ZZ	&	.31{$^{***}$}	&	.02				&	.03				&	.20{$^{**}$}	&	.00				&	.34{$^{***}$}	&	.09				&	.11				&	.04			&	.28{$^{***}$}	&	.05				&	.05				&	.08				&	.38{$^{***}$}	&	.10	&&&	\\
17	&	OE	&	.06				&	-.01			&	-.01			&	.07				&	-.05			&	.04				&	.12				&	.46{$^{***}$}	&	.15{$^{*}$}&	-.01			&	-.13			&	.15{$^{*}$}		&	.13					&	.03	&	.13		& -.05&&	\\
...
Und als letztes sei noch erwähnt, dass die Bedingungen der \gls{ha} alle signifikant negativ mit dem \gls{zwert} des \gls{bist} korrelierten ($r_{s}=-.15$ bis $-.32$, alle $p\textnormal{s}<.05$), während die Bedingungen der \gls{ssauf} alle nicht signifikant mit dem \gls{zwert} zusammenhingen ($r_{s}=.04$ bis $-.14$, alle $p\textnormal{s}>.05$).
...
Mit der ersten Fragestellung sollte geprüft werden, ob der von \citet{Melnick2013} berichtete Zusammenhang zwischen dem \gls{si} und psychometrischer Intelligenz (Studie 1: $r~=~.64$, $p~=~.02$ und Studie 2: $r~=~.71$, $p~<~.001$) bestätigt werden kann. 

In der vorliegenden Arbeit korrelierte der \gls{si} nicht substanziell mit dem \gls{zwert} aus dem \gls{bist} $r_{s}~=~.04$ ($p~=~.57$; siehe Abbildung~\ref{fig:si-z}).
...
\begin{figure}[htbp]
	...
	\caption[Spatial-Index-Intelligenz-Zusammenhang]{Zusammenhang ($r_{s}=.04$, $p=.57$) zwischen dem \gls{si} und dem \gls{zwert} aus dem \gls{bist}. Der \gls{si} wurde als Differenz zwischen der $\log_{10}$-Schwellenschätzung für die Mustergrösse \(7.2^{\circ}\) und der $\log_{10}$-Schwellenschätzung für die Mustergrösse \(1.8^{\circ}\) gebildet. Der \gls{zwert} des \gls{bist} wurde als Mittel aller 18 \textit{z}-standardisierter Subtests gebildet.}
	\label{fig:si-z}
\end{figure}
