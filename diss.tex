...
Dabei hat sich ergeben, dass sich der in der vorliegenden Studie ermittelte Korrelationskoeffizient $r~=~.00$ signifikant von den von \citet{Melnick2013} berichteten $r~=~.64$ und $r~=~.71$ unterschied ($p=.04$ respektive $p<.001$).
