...
Obwohl der \gls{rmse} für einige \glspl{vp} sehr gross ausfiel, eignete sich ein exponentielles Modell zur Beschreibung der Daten für einen grossen Teil der \glspl{vp} gut (siehe \autoref{fig:rmse_density}). Der Median betrug $6$ ms und das dritte Quartil lag bei $9$ ms.
...
Alle Modell-Fits der in den folgenden Unterabschnitten berichteten \gls{flm}e sind in \autoref{tab:fixed-links_measurement_models_spatial_suppression} aufgeführt.
