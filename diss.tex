...
Shapiro-Wilk-Test\footnote{Liberalere Tests wie der Anderson-Darling- oder der Lilliefors-Test  kamen zum gleichen Ergebnis wie der vergleichsweise konservative Shapiro-Wilk-Test. Im Folgenden werden nur noch die Ergebnisse von Shapiro-Wilk-Tests berichtet. Wenn nicht vermerkt, kamen liberalere Tests jeweils zum gleichen Ergebnis. Siehe \citet{Razali2011} für die Teststärken der verwendeten Tests.} 
eingesetzt.
...
\begin{figure}[htb]
	...
	\caption[Suppression-Index Histogramm]{Histgramm des \gls{si}.}
	\label{fig:SIhist}
\end{figure}
